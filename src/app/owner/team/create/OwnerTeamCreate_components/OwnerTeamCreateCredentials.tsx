      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-1">
          ...
          <input 
            ...
            value={formData.email} onChange={e => setFormData((p: any) => ({...p, email: e.target.value}))}
        ...
        <div className="space-y-1">
          ...
          <input 
            ...
            value={formData.password} onChange={e => setFormData((p: any) => ({...p, password: e.target.value}))}
            className="w-full bg-input border border-border rounded-md px-3 py-2 text-sm text-primary focus:border-primary outline-none"
          />
