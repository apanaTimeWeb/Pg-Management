  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {widgets.map((w, i) => {
        const Icon = w.icon;
        return (
          <div key={w.label} className="bg-gradient-to-br from-bg-card to-bg-page border border-border rounded-[var(--radius-lg)] p-5 motion-safe:hover:-translate-y-1 hover:border-primary hover:shadow-md shadow-sm motion-safe:transition-all group relative overflow-hidden">
