        ...
        <div className="bg-card border border-border rounded-[var(--radius-lg)] p-5">
          ...
          {occupancy && (
            <div className="space-y-4">
              ...
              <div className="w-full bg-input rounded-full h-3 overflow-hidden flex">
                <div className="bg-success h-3" style={{ width: `${(occupancy.occupiedBeds / occupancy.totalBeds) * 100}%` }}></div>
                <div className="bg-warning h-3" style={{ width: `${(occupancy.maintenanceBeds / occupancy.totalBeds) * 100}%` }}></div>
              </div>
              ...
              <div className="flex justify-between text-xs font-bold pt-2">
                ...
                <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-input border border-border"></span> Vacant ({occupancy.vacantBeds})</span>
                <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-warning"></span> Maintenance ({occupancy.maintenanceBeds})</span>
              </div>
            </div>
          )}
        </div>
