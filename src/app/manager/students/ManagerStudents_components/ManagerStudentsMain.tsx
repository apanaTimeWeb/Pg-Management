  ...
  return (
    <div className="space-y-6 pb-20 manager-theme animate-fade-in">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-[24px] font-bold text-primary tracking-tight">Student Management</h1>
          <p className="text-sm text-secondary">Manage residents, rent, and KYC.</p>
        </div>
        <button 
      ...
      <div className="bg-card border border rounded-[var(--radius-lg,12px)] p-4 flex flex-col md:flex-row gap-4">
        <div className="relative flex-1">
          <Search className="w-5 h-5 absolute left-3 top-1/2 -translate-y-1/2 text-secondary" />
          <input 
            type="text" 
            placeholder="Search by name or phone..." 
            className="w-full bg-input border border rounded-[var(--radius-md,8px)] pl-10 pr-4 py-2 text-sm text-primary focus:outline-none focus:border-theme-primary transition-colors"
            value={searchTerm}
        ...
        <div className="flex items-center gap-2">
          ...
          <select 
            className="bg-input border border rounded-[var(--radius-md,8px)] px-4 py-2 text-sm text-primary focus:outline-none focus:border-theme-primary transition-colors font-medium"
            value={filterStatus}
