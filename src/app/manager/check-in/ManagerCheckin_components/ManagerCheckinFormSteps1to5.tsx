    ...
    <>
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" placeholder="12-digit Aadhar" value={formData.documents.aadharNumber} onChange={e => setFormData({...formData, documents: {...formData.documents, aadharNumber: e.target.value}})} className="w-full bg-[var(--bg-input)] border border-[var(--border)] rounded px-3 py-2 text-[var(--text-primary)] focus:border-[var(--primary)] outline-none" />
            </div>
            <div>
              <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">PAN Number</label>
              <input type="text" placeholder="10-digit PAN (Optional)" value={formData.documents.panNumber} onChange={e => setFormData({...formData, documents: {...formData.documents, panNumber: e.target.value}})} className="w-full bg-[var(--bg-input)] border border-[var(--border)] rounded px-3 py-2 text-[var(--text-primary)] focus:border-[var(--primary)] outline-none uppercase" />
            </div>
          </div>
          <div className="border-2 border-dashed border-[var(--border)] rounded-xl p-8 text-center bg-[var(--primary-subtle)] mt-4">
            ...
            <button onClick={() => setFormData({...formData, documents: { ...formData.documents, files: [{name: 'aadhar_front.jpg'}, {name: 'aadhar_back.jpg'}] }})} className="px-4 py-2 bg-[var(--bg-input)] border border-[var(--border)] text-[var(--text-primary)] rounded text-sm hover:bg-[var(--primary-subtle)] transition-colors">
      ...
      {step === 5 && (
        <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
          ...
          <div className="bg-[var(--success-bg)] border border-[var(--success)] rounded-xl p-4 flex items-center justify-between">
            <div>
